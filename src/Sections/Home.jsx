    ...
    <section id="home" className="w-full min-h-screen relative bg-[#0a0e27] overflow-hidden">
      ...
      <div className="relative z-10 h-full w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid grid-cols-1 lg:grid-cols-2 items-center gap-8 py-20 lg:py-0 min-h-screen">
        <div className="flex flex-col justify-center h-full mt-9 text-center lg:text-left space-y-6">
          ...
          <motion.div className="space-y-4 text-base sm:text-lg text-gray-400 max-w-2xl mx-auto lg:mx-0" initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.4, duration: 0.8 }}>
          ...
          <motion.div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start pt-4">
            <a href="#projects" className="px-8 py-4 rounded-full bg-white text-[#0a0e27] font-semibold hover:bg-gray-100 transition-all">View my Work</a>
            <a href="/resume.pdf" download className="px-8 py-4 rounded-full border-2 border-gray-600 text-gray-300 hover:text-white hover:border-gray-500 transition-all">My Resume</a>
          </motion.div>

          <div className="flex gap-4 justify-center lg:justify-start pt-4">
            {socials.map(({ Icon, href }, i) => (
              <a key={i} href={href} target="_blank" rel="noopener noreferrer" className="w-12 h-12 rounded-full border-2 border-gray-600 text-gray-400 hover:text-gray-300 hover:border-gray-500 transition-all flex items-center justify-center">
                <Icon />
              </a>
            ))}
          </div>
        ...
        <div className="hidden lg:flex items-center justify-center h-full relative">
          <div className="w-[32rem] h-[32rem] rounded-full bg-gradient-to-br from-gray-800/20 to-gray-700/20 border-2 border-gray-600 flex items-center justify-center">
